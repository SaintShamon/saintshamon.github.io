<?php 
    ...
    $count = count(get_sub_field('files_list'));
    $count = round($count/2);
    if(have_rows('files_list')):
?>
<section class="list_pdf_image section">
    <div class="container">
            ...
            <div class="content_wrapper">
                <div class="col title_col">
                    ...
                    <ul class="list_pdf">
                        ...
                        $i = 1; 
                        ?>
                        <?php while(have_rows('files_list')): the_row(); ?>
                            <?php if($i <= $count): ?>
                                <?php 
                                ...
                                ?>
                                    <li>
                                        <a href="<?php echo $file['url']; ?>" class="button button--pdf"  target="_blank">
                ...
                <?php if($image): ?>
                    <div class="col list_pdf_image__image">
