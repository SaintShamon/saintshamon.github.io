			...
			<div class="section container searchBlock__item__title">
	  			<div class="row">
	  				<div class="col-lg-10 offset-lg-1">
					  	<h1 class="h1 searchBlock__title"><?php printf( __( 'Search results for: %s', 'arken' ), get_search_query() ); ?></h1>
								...
								<ul class="searchBlock__list">
									<?php while ( have_posts() ) : the_post(); ?>
										<li class="searchBlock__item">
											...
											<a class="text--18 link--underline--2 text--color--primary searchBlock__item__link" href="<?php the_permalink(); ?>"><?php _e('Read More','arken'); ?></a>
										</li>
									<?php endwhile; ?>
								</ul>
						<?php else : ?>
